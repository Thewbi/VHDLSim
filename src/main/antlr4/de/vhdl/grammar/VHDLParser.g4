...
// reuse the token which have been defined in the lexer
// otherwise the parser is generated with it's own tokens that will
// not match the token, that the lexer outputs
options {
